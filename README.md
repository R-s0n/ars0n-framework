...
<h3 align="center"><em>THIS PROJECT HAS BEEN PUT ON HOLD AND IS NO LONGER BEING ACTIVELY SUPPORTED AT THIS TIME.  I AM CURRENTLY WORKING WITH A TEAM OF ENGINEERS TO BUILD A FULLY DOCKERIZED VERSION OF THIS FRAMEWORK THAT WILL RESOLVE THE INSTALLATION ISSUES AND EXPAND THE CAPABILITIES DRAMATICALLY.  I WILL POST UPDATES ON MY LINKEDIN WHEN WE ARE CLOSER TO RELEASING THE NEW VERSION OF THE FRAMEWORK.</em></h3>
