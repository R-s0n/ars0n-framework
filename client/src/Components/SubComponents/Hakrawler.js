        ...
        <div className="container mt-5">
            <div className="row">
                <div className="col-12">
                    ...
                    <p><b>DOWNLOAD: </b><span onClick={notify}>go install github.com/hakluke/hakrawler@latest</span><div>NOTE: Remember to add go to your path</div></p>
                    <p><b>INSTALL: </b><span onClick={notify}>sudo apt-get install golang</span></p>
