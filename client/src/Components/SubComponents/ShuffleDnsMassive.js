        ...
        <div className="container mt-5">
            <div className="row">
                <div className="col-12">
                    ...
                    <p><b>Run: </b><span onClick={copyToClipboard}>~/go/bin/shuffledns -d {props.thisFqdn.fqdn} -w ~/Wordlists/all.txt -r ~/Wordlists/resolvers.txt | xclip -i -selection clipboard</span></p>
                </div>
            </div>
            <div className="row">
                {
