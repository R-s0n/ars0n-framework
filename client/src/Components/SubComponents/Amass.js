        ...
        <div className="container mt-4">
            <div className="row">
                <div className="col-12">
                    ...
                    <p><b>DOWNLOAD / INSTALL: </b><span onClick={notify}>sudo apt-get install amass or go install -v github.com/owasp-amass/amass/v4/...@master</span></p>
                    <p><b>RUN (PASSIVE): </b><span onClick={notify}>amass enum --passive -d {props.thisFqdn.fqdn} -o {props.thisFqdn.fqdn}.txt; cat {props.thisFqdn.fqdn}.txt | xclip -i -selection clipboard</span></p>
                    <p><b>RUN (ACTIVE): </b><span onClick={notify}>amass enum  -src -ip -brute -min-for-recursive 2 -d {props.thisFqdn.fqdn} -o amass.{props.thisFqdn.fqdn}.txt; cp amass.{props.thisFqdn.fqdn}.txt amass.{props.thisFqdn.fqdn}.full.txt; sed -i -E 's/\[(.*?)\] +//g' amass.{props.thisFqdn.fqdn}.txt; sed -i -E 's/ ([0-9]{regex}\.)[0-9].*//g' amass.{props.thisFqdn.fqdn}.txt; cat amass.{props.thisFqdn.fqdn}.txt | xclip -i -selection clipboard</span></p>
                    <Toaster />
                </div>
            </div>
            <div className="row">
