...
const AddFqdnModal = props => {
    ...
    const handleSubmit = (e) => {
        ...
        if (file) {
            ...
            reader.onload = (e) => {
                try {
                    ...
                    if (Array.isArray(inScope)) {
                        ...
                        axios.all(domains.map(domain => axios.post(`http://${process.env.REACT_APP_API_IP}:${process.env.REACT_APP_API_PORT}/api/fqdn/new`, { fqdn: domain })))
            ...
            axios.post(`http://${process.env.REACT_APP_API_IP}:${process.env.REACT_APP_API_PORT}/api/fqdn/new`, { fqdn: domain })
                .then(res => {
